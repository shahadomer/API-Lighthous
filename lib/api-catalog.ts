// NOTE: All data in this file is clearly labelled sample/fixture data.
// Provider names are fictional (Air Data, SkyFare, Ledger Labs, etc.).
// No real company's name, logo or pricing appears here.
// This data must never reach a production index.
