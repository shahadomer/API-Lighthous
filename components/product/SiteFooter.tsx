...
const columns = [
  {
    ...
    links: [
      ...
      { href: "/apis", label: "Airline APIs" },
      { href: "/apis", label: "Business Data" },
      { href: "/apis", label: "Communications" },
    ],
  },
  {
    heading: "Providers",
    links: [
      ...
      { href: "/signup", label: "Publish your API" },
      { href: "/guides", label: "Pricing guides" },
    ],
  },
  {
    heading: "Developers",
